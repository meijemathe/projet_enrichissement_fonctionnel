...
ui = dashboardPage(
        ...
        dashboardBody(
                tabItems(
                        ...
                        # 4th tab content : protein domain enrichment
                        tabItem("prot_enrichment",
                                ...
                                box2(
                                        ...
                                        plotOutput("domain_barplot")%>% withSpinner(color="#0dc5c1")
                                ),
                                box2(
                                        title = "Domain barplot plot",
                                        plotOutput("domain_barplot2")%>% withSpinner(color="#0dc5c1")
                                ),
                                box2(
                                        title = "Domain dotplot plot",
                                        plotOutput("domain_dotplot")%>% withSpinner(color="#0dc5c1")
                                ),
